...
UNITREE_MODEL_DIR = "D:\\unitree\\unitree_rl_lab\\unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "D:\\unitree\\unitree_rl_lab\\unitree_ros"  # 模型文件存放位置
